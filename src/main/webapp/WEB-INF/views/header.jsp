...
<body>
<div class="loogo">
<a href="loginMain"><img id="logo" src="resources/logos/logo.png"></a>
</div>
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="loginMain">타볼래
</a>
    </div>
    ...
    <li><a href="mypage"><span class="glyphicon glyphicon-user"></span>내정보</a></li>
